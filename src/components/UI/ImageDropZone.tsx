...
const ImageDropZone = ({
  ...
  return (
    <div
      className="w-full h-full overflow-hidden relative cursor-pointer hover:opacity-70"
    ...
    >
      ...
      {imageObject ? (
        ...
        <div className="flex flex-col justify-center items-center w-full h-full font-normal size-xs border-2 border-componentBorder rounded-lg">
          <HiOutlineUpload className="w-8 h-8" />
          <span className="w-full text-center">PNG, JPG, GIF, WEBP.</span>
        </div>
      )}
    </div>
  );
